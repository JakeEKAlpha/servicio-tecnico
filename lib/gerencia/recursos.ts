...
export const RECURSOS: Record<string, RecursoConfig> = {
  ingenieros: {
    ...
    campos: [
      ...
      {
        k: "sucursal",
        label: "Sucursal (texto — legado)",
        tipo: "select",
        opciones: "sucursales",
        ayuda: "Sigue siendo lo que usa la asignación de órdenes. sucursal_id es la referencia formal, se mantienen sincronizados a mano por ahora.",
      },
      {
        k: "sucursal_id",
        label: "Sucursal",
