  ...
  cuentas: {
    ...
    campos: [
      ...
      },
      {
        ...
        tipo: "area",
        ayuda: "Solo para cuentas que aún no se dividieron en los campos de abajo — ver Directorio de Cuentas.",
        enTabla: false,
      },
      {
        k: "confirmacion_acceso",
        label: "Requiere confirmación de acceso",
        tipo: "bool",
      },
      {
        k: "equipo_seguridad",
        label: "Requiere EPP",
        tipo: "bool",
        ayuda: "El ingeniero debe llevar equipo de seguridad en sitio.",
      },
      {
        k: "identificacion_requerida",
        label: "Requiere identificación",
        tipo: "bool",
        ayuda: "El ingeniero debe presentar identificación oficial/credencial en sitio.",
      },
      {
        k: "anticipacion",
        label: "Anticipación",
        tipo: "text",
        ayuda: "Cuánto aviso pide la cuenta antes de la visita.",
        enTabla: false,
      },
      {
        k: "requiere_correo",
        label: "Requiere correo previo",
        tipo: "bool",
      },
      {
        k: "destinatario_correo",
        label: "Destinatario del correo",
        tipo: "text",
        enTabla: false,
      },
      { k: "cc_correo", label: "CC del correo", tipo: "text", enTabla: false },
      {
        k: "datos_correo",
        label: "Qué incluir en el correo",
        tipo: "area",
        enTabla: false,
      },
      {
        k: "horario_restringido",
